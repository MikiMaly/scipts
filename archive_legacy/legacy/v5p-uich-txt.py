...
def load_config(path: str) -> dict:
    ...
    cfg.setdefault("csv_file", "")  # optional: explicit path/name
...
def find_csv(script_dir: Path, cfg: dict) -> Path | None:
    # explicit config
...
def main():
    ...
    if cfg.get("csv_autoload", True):
        ...
        if csv_path:
            ...
            count = daemon.enqueue_many(urls)
